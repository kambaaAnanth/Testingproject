...
public class Subcomponent_Deactivebutton  extends Common_Loginsuccessful_Function {
	@Test
	public void SubcomponentDeactivebutton() throws InterruptedException, AWTException {
		...
		Thread.sleep(2000);
		Subcomponent_function.deactive.click();
		Subcomponent_function.submit.click();
		String actual=Subcomponent_function.active.getText();
