...
public class Verify_block_add_alreadyexistname extends Common_Loginsuccessful_Function{
	@Test
	public void BlockAdd() throws InterruptedException, IOException{
		...
		Files.copy(src, new File("C:\\Users\\kavya\\Desktop\\TANHODA\\Already exist block name.png"));
	}
