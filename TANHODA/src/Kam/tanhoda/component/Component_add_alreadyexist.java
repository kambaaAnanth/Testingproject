...
public class Component_add_alreadyexist  extends Common_Loginsuccessful_Function {
	@Test
	public void Componentaddalreadyexist() throws InterruptedException, AWTException, IOException {
		...
		Thread.sleep(2000);
		Component_function.addnew.click(); 
        ...
        Component_function.save1.click();
    	File src = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		Files.copy(
				src,
				new File(
						"C:\\Users\\kavya\\Desktop\\TANHODA\\Already exist component name.png"));
}
