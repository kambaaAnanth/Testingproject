...
public class Usermanagement_Deactivebuttton extends
	...
	public void deactive() throws InterruptedException {
		...
		Thread.sleep(1000);
		Usermanagement_function.Deactive.click();
		Usermanagement_function.update.click();
		String actual = Usermanagement_function.Active.getText();
