...
public class Usermanagement_add_alreadyexist extends
		Common_Loginsuccessful_Function {
	@Test
	public void usermanagementaddalreadyexist() throws InterruptedException,
			IOException {
		...
		Files.copy(
				src,
				new File(
						"C:\\Users\\kavya\\Desktop\\TANHODA\\Already exist usermanagement name.png"));
	}
