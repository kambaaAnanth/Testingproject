...
public class Verify_district_edit_alreadyexistname extends Common_Loginsuccessful_Function{
	...
	if(	District_edit.districtname.isEnabled()){
		...
		Files.copy(src, new File("C:\\Users\\kavya\\Desktop\\TANHODA\\Already exist edited district name.png"));
}
