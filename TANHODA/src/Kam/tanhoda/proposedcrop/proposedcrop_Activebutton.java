...
public class proposedcrop_Activebutton extends Common_Loginsuccessful_Function {
	@Test
	public void proposedcropActivebutton() throws InterruptedException, AWTException, IOException {
		...
		Thread.sleep(2000); 
		Proposedcrop_function.active.click();{
		String actual=Proposedcrop_function.deactive.getText();
