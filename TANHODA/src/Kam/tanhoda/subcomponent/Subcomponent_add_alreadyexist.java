...
public class Subcomponent_add_alreadyexist extends Common_Loginsuccessful_Function {
	@Test
	public void Subcomponentaddalreadyexist() throws InterruptedException, AWTException, IOException {
   ...
   Component_function.save1.click();
	...
	Files.copy(
			src,
			new File(
					"C:\\Users\\kavya\\Desktop\\TANHODA\\Already exist subcomponent name.png"));    
}
