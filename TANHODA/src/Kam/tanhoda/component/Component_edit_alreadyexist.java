...
public class Component_edit_alreadyexist  extends Common_Loginsuccessful_Function {
	@Test
	public void Componenteditalreadyexist() throws InterruptedException, AWTException, IOException {
		...
		Files.copy(
				src,
				new File(
						"C:\\Users\\kavya\\Desktop\\TANHODA\\edit block name Already exist.png")); 
