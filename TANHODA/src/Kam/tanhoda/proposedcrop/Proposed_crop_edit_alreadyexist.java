...
public class Proposed_crop_edit_alreadyexist  extends Common_Loginsuccessful_Function {
	@Test
	public void Proposedcropeditalreadyexist() throws InterruptedException, AWTException, IOException {
		...
		Thread.sleep(2000); 
		Proposedcrop_function.edit.click();
		if(Proposedcrop_function.cropname.isEnabled()){
			Proposedcrop_function.cropname.clear();
			Proposedcrop_function.cropname.sendKeys("paddy");
			Proposedcrop_function.save1.click();
		}
		File src = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		Files.copy(
				src,
				new File(
						"C:\\Users\\kavya\\Desktop\\TANHODA\\proposed crop edited name already exist.png"));
	}
