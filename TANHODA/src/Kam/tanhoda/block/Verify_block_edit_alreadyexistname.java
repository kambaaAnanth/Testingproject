...
public class Verify_block_edit_alreadyexistname extends Common_Loginsuccessful_Function {
	@Test
	public void Blockedit() throws InterruptedException, IOException{
     ...
     if(Block_Add_Successfully.editblockcode.isEnabled()){
 		...
 		Files.copy(src, new File("C:\\Users\\kavya\\Desktop\\TANHODA\\Already exist edit block name.png"));
     }
