...
public class Verify_district_add_alreadyexistname extends Common_Loginsuccessful_Function{
		...
		public void districAdd() throws InterruptedException, IOException{
			...
			Thread.sleep(1000);
			Pagefactory.district.District_Add_Function.district.sendKeys("Kancheepuram");
			Pagefactory.district.District_Add_Function.districtcode.sendKeys("12345");
			Pagefactory.district.District_Add_Function.officeaddress.sendKeys("Acharapakkam");
			Pagefactory.district.District_Add_Function.save.click();
			File src= ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
			Files.copy(src, new File("C:\\Users\\kavya\\Desktop\\TANHODA\\Already exist district name.png"));
		}
		}
