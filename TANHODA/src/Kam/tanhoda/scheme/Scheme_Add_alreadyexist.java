...
public class Scheme_Add_alreadyexist extends Common_Loginsuccessful_Function {
	@Test
	public void SchemeAddalreadyexist() throws InterruptedException, AWTException, IOException{
		...
		Pagefactory.scheme.Scheme_Function.schemename
				.sendKeys("NBM");
		Pagefactory.scheme.Scheme_Function.shortname.sendKeys("NBM");
		...
		Files.copy(
				src,
				new File(
						"C:\\Users\\kavya\\Desktop\\TANHODA\\Already exist Scheme name.png"));
	}
