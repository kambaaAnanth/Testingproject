...
public class Verify_village_edit_alreadyexistname extends Common_Loginsuccessful_Function{
	@Test
	public void villageadd() throws InterruptedException, IOException{
		...
		Pagefactory.Village.Village_Add.update.click();
		 File src= ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
	 		Files.copy(src, new File("C:\\Users\\kavya\\Desktop\\TANHODA\\Already exist edited village name.png"));
	}
