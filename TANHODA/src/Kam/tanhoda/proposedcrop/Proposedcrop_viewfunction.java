...
public class Proposedcrop_viewfunction extends Common_Loginsuccessful_Function {
	@Test
	public void Proposedcropviewfunction() throws InterruptedException, AWTException, IOException {
		...
		Thread.sleep(2000); 
		Proposedcrop_function.view.click();
		File src = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		Files.copy(
				src,
				new File(
						"C:\\Users\\kavya\\Desktop\\TANHODA\\view prposed crop name.png"));
}
}
