...
public class Subcomponent_activebutton  extends Common_Loginsuccessful_Function {
	@Test
	public void Subcomponentactivebutton() throws InterruptedException, AWTException {
		...
		Thread.sleep(2000);
		Subcomponent_function.active.click();
		
		String actual=Subcomponent_function.deactive.getText();
