...
public class Scheme_Activebutton extends Common_Loginsuccessful_Function {
	@Test
	public void SchemeActivebutton() throws InterruptedException, AWTException {
		...
		Thread.sleep(2000);
		Pagefactory.scheme.Scheme_Function.active.click();
		String actual=Pagefactory.scheme.Scheme_Function.deactive.getText();
