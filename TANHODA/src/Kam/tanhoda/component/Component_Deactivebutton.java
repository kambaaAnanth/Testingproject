...
public class Component_Deactivebutton  extends Common_Loginsuccessful_Function {
	@Test
	public void ComponentDeactivebutton() throws InterruptedException, AWTException {
		...
		Thread.sleep(2000); 
		Component_function.deactive.click();
		Component_function.submit.click();
		String actual=Component_function.active.getText();
