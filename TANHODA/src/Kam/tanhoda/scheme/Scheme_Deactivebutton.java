...
public class Scheme_Deactivebutton extends Common_Loginsuccessful_Function {
	@Test
	public void SchemeDeactivebutton() throws InterruptedException, AWTException {
		...
		Thread.sleep(2000);
		Pagefactory.scheme.Scheme_Function.deactive.click();
		Pagefactory.scheme.Scheme_Function.update.click();
		String actual=Pagefactory.scheme.Scheme_Function.active.getText();
