...
public class Verify_DeActivatebutton extends Common_Loginsuccessful_Function {
	@Test
	public void Deactivebutton() throws InterruptedException {
		...
		Thread.sleep(2000);
		Pagefactory.Village.Village_Add.deactivate.click();
		Pagefactory.Village.Village_Add.save.click();
		String actual = Pagefactory.Village.Village_Add.Active.getText();
