...
public class Verify_village_add_alreadyexistname extends
		Common_Loginsuccessful_Function {
	@Test
	public void villageaddalreadyexist() throws InterruptedException,
			IOException {
		...
		Files.copy(
				src,
				new File(
						"C:\\Users\\kavya\\Desktop\\TANHODA\\Already exist village name.png"));
	}
